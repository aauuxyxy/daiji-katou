  ...
  const aboutItems = [
    {
      ...
      description:
        '2023年12月1日に株式会社メンバーズに入社しました。前職の開発経験を生かし金融系企業の運用・保守やプラント清掃業務管理アプリケーションの新規開発などに従事しておりました。',
    },
    {
      label: '直近業務',
      value: 'フロント/バックエンド開発業務',
      ...
      description:
        'プラント清掃業務管理アプリの新規開発PJにてNuxtを活用したフロントエンド開発を担当しておりました。開発のみならずデザインチームとの折衝を通じてユーザー目線のUI提案なども行っておりました。',
    },
    {
      label: '利用技術',
      value: 'TypeScript/React/Express',
      ...
      description:
        'これまでTypeScriptをメインに開発を行っておりました。また、フロントエンドでは主にReactやNext.js、バックエンドではExpressを主として活用しておりました。',
    },
  ];
